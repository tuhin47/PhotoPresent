        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(final String response) {
                        ...
                        courseadapter= new ArrayAdapter<String>(CourseSelectionActivity.this,android.R.layout.simple_selectable_list_item,coursename);
                        ...
                        courseview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                               ...
                               // String courseName=(String) ((ListView) courseview.getSource()).getSelectionModel().getSelectedItem();
                                Intent intent = new Intent(CourseSelectionActivity.this,SetDurationActivity.class);
