        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(final String response) {
                        ...
                        courseadapter= new ArrayAdapter<String>(GetDataActivity.this,android.R.layout.simple_selectable_list_item,coursename);
                        ...
                        courseview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                                ...
                                String URL=MainActivity.url+"?tag=CSV&"+"coursename="+courseName;
...
//                                Intent intent = new Intent(GetDataActivity.this,SelectDateActivity.class);
