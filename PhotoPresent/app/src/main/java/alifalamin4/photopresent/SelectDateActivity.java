...
public class SelectDateActivity extends AppCompatActivity {
    ...
    public static String dateOfAttendence;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("Ulala" + CourseSelectionActivity.courseName);
                ...
                String URL = SERVER_URL+"?tag=reg&"+"coursename="+CourseSelectionActivity.courseName+"&date="+dateOfAttendence;
