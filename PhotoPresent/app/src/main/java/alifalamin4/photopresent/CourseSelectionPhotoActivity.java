 ...
 */
public class CourseSelectionPhotoActivity extends AppCompatActivity {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(final String response) {
                        ...
                        courseadapter= new ArrayAdapter<String>(CourseSelectionPhotoActivity.this,android.R.layout.simple_selectable_list_item,coursename);
                        ...
                        courseview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                                ...
                                Intent intent = new Intent(CourseSelectionPhotoActivity.this,SetDurationPhotoActivity.class);
